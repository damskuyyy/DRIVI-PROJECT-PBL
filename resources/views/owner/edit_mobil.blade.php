                ...
                <form class="row g-3" method="post" action="{{route('owner.update_mobil',$editData->id)}}">
                  @csrf
                    ...
                    <div class="col-md-6 ">
                      ...
                      <input type="text" class="form-control" value="{{$editData->nama_mobil}}" id="mobil" name="nama_mobil" required data-validation-required-message="This field is required" >
                    </div>
                    <div class="col-md-6 pt-4">
                      <label for="jenis" class="form-label">Jenis Mobil</label>
                      <input type="text" class="form-control" value="{{$editData->jenis_mobil}}" id="jenis" name="jenis_mobil" required data-validation-required-message="This field is required">
                    </div>
                    <div class="col-md-6 pt-4">
                    ...
                    <div class="col-md-6 pt-4">
                      ...
                      <input type="text" class="form-control" value="{{$editData->jumlah_kursi}}" id="kursi" name="jumlah_kursi" required data-validation-required-message="This field is required">
                    </div>
                    <div class="col-md-6 pt-4">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="bahanBakar" name="bahan_bakar">
                    ...
                    <div class="col-md-6 pt-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="bahanBakar" name="jenis_transmisi">
