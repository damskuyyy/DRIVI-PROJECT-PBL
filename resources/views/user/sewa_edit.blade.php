            ...
            <div class="container-fluid">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Rubah Jadwal Sewa</h6>
                </div>
                <div class="card-body">

                <form class="row g-3" method="POST" action="{{route('user.sewa_update', $editData->id)}}" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="col-md-6 pt-4">
                        ...
                        <div class="input-group mb-3">
                            <input type="datetime-local" class="form-control" id="tanggal_sewa" name="tanggal_sewa" aria-describedby="basic-addon1" value="{{$editData->tanggal_sewa}}"required data-validation-required-message="Tidak boleh kosong">
                        </div>
                    </div>
                    <div class="col-md-6 pt-4">
                      <label for="tanggal_pengembalian" class="form-label">Tanggal Pengembalian</label>
                      <input type="datetime-local" class="form-control" id="tanggal_pengembalian" name="tanggal_pengembalian" value="{{$editData->tanggal_pengembalian}}"required data-validation-required-message="Tidak boleh kosong">
                    </div>
                   
                    
                    <div class="col-12 pt-4">
                      <button type="submit" class="btn btn-warning col-12" required data-validation-required-message="Tidak boleh kosong">Ubah Jadwal Sewa</button>
                    </div>
                  </form>
